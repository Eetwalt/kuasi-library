// script tester
const testText = document.querySelector("[kuasi-element=test]");

window.onload = function() {
  console.log("Your script is working!");
  testText.textContent = "Hello component page!";
};
...
copyButton.addEventListener("click", (event) => {
  ...
  const copyJson = (event) => {
    ...
    const componentJson = copyButton.querySelector('[kuasi-data="json"]')
      .textContent;
